...
// 사용자의 예약 목록 조회
$bookings_query = "SELECT b.*, s.name as station_name, s.address, s.price 
                   FROM bookings b 
...
?>
            ...
            <div class="bookings-list">
                <?php if(count($bookings) > 0): ?>
                    <?php foreach($bookings as $booking): ?>
                        <div class="booking-card" data-status="<?php echo $booking['status']; ?>" data-date="<?php echo $booking['start_time']; ?>">
                            ...
                            <div class="booking-details">
                                <div class="detail-row">
                                    <div class="detail-item">
                                        ...
                                        <span class="detail-value"><?php echo date('Y-m-d H:i', strtotime($booking['start_time'])); ?></span>
                                    </div>
                                    <div class="detail-item">
                                ...
                                <div class="detail-row">
                                    <div class="detail-item">
                                        ...
                                        <span class="detail-value"><?php echo date('Y-m-d H:i', strtotime($booking['created_at'])); ?></span>
                                    </div>
                                    <div class="detail-item">
                                        <span class="detail-label">총 비용</span>
                                        <span class="detail-value cost"><?php echo number_format($booking['total_cost']); ?>원</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="booking-actions">
                                <?php if($booking['status'] === 'active'): ?>
                                    ...
                                    <?php if($can_cancel): ?>
                                        <button class="btn btn-danger" onclick="cancelBooking(<?php echo $booking['id']; ?>)">예약 취소</button>
                                    <?php endif; ?>

                                    <button class="btn btn-success" onclick="completeBooking(<?php echo $booking['id']; ?>)">충전 완료</button>
                                    <button class="btn btn-outline" onclick="extendBooking(<?php echo $booking['id']; ?>)">시간 연장</button>

                                <?php elseif($booking['status'] === 'completed'): ?>
                                    <button class="btn btn-outline" onclick="showReceipt(<?php echo $booking['id']; ?>)">영수증 보기</button>
    ...
    <script>
      ...
      function completeBooking(bookingId) {
        if (!confirm('충전을 완료하시겠습니까?')) return;
